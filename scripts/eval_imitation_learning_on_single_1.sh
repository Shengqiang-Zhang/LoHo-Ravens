...
do
    ...
    CUDA_VISIBLE_DEVICES=${GPU1} \
        ...
        ${CKPT} \
        test \
        ${t} | tee -a results/eval_imitation_learning_last_unseen_june6_first_part.txt
done


# for t in ${LOHORAVENS_TASKS_1}
# do
#     echo "evaluating the task: ${t}"
#     CUDA_VISIBLE_DEVICES=${GPU1} \
#         bash scripts/eval_imitation_learning.sh \
...
#         ${CKPT} \
#         test \
#         ${t} | tee results/eval_imitation_learning_last_june5_first_part.txt
# done
