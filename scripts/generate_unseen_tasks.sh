DATA_DIR=/nfs/gdata/shengqiang/cliport/loho-ravens/data_v2/unseen/
DISP=False
...
LANG_TASKS='pick-and-place-primitive pick-and-place-primitive-with-size'
...
LOHORAVENS_TASKS='stack-smaller-over-bigger-with-same-color stack-smaller-over-bigger-with-same-color-in-same-color-zone stack-blocks-by-relative-position-and-color-and-size stack-blocks-by-absolute-position-and-color-and-size move-blocks-between-absolute-positions-by-size-and-color put-even-blocks-in-same-color-zone put-block-into-matching-bowl put-hidden-blocks-in-three-layer-towers-into-matching-bowls put-hidden-blocks-in-pyramid-into-matching-bowls stack-blocks-with-alternate-color stack-blocks-by-color-in-size-order'

for task in $LOHORAVENS_TASKS; do
